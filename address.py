...
boton_eliminar = tk.Button(
    marco_botones_abajo, text="Eliminar Contacto", command=eliminar_contacto
)
...
boton_mostrar_info = tk.Button(
    marco_botones_abajo, text="Mostrar Info", command=mostrar_info_contacto
)
boton_mostrar_info.pack(side="left", anchor="nw", padx=(0, 10))

# Boton para agregar dummy info
boton_fake = tk.Button(
    marco_botones_abajo, text="F data", command=agregar_contactos_falsos
)
